...
FECHA 10/07/2022
TITULO: EDITA PRIORIDAD -->

<!DOCTYPE html>
<%@page import="Entidad.Prioridades"%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="Utilidades.ConexionDB,java.sql.*,DAO.PrioridadesDAO" %>
<html>
<head>
...
<%
    	    ...
    	    Prioridades bean = obj.buscarPrioridad(cod);
                ...
                <div class="row">
	                ...
	                <div class="col-6 p-5" >
						<div class="text-center">
	                         <h1 class="h4 text-gray-900 mb-4">Editar Prioridad</h1>
	                    </div>
	                    <form class="user">
	                                    	<div class="form-group">
	                                           <input type="text" name="cod" class="form-control form-control-user" value="<%=bean.getIdPrioridades()%>"
                               					readonly="readonly">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Status..." name="txtPrioridades" value="<%=bean.getPrioridades()%>">
	                                        </div>
								        ...
								        function enviarDatos(){
								        	if(document.forms[0].txtPrioridades.value.length==0){
								        		alert("Ingrese Prioridades");
								            	return;	
								        	}
								
								        	document.forms[0].accion.value="editarPrioridad";
								        	document.forms[0].submit();
								        }
								        </script>
								        
								        <%
								        if(request.getParameter("accion")!=null && request.getParameter("accion").equals("editarPrioridad")){
								      	  
								        	Prioridades beanPrioridad = new Prioridades();
								        	
								        	beanPrioridad.setIdPrioridades(request.getParameter("cod"));
										  	beanPrioridad.setPrioridades(request.getParameter("txtPrioridades"));
										  	
								            obj.actualizar(beanPrioridad);
