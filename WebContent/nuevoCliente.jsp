...
FECHA 10/07/2022
TITULO: CREA NUEVO CLIENTE -->


<!DOCTYPE html>
<html lang="en">
<%@page import="Entidad.Clientes,DAO.ClientesDAO,java.util.ArrayList" %>
<head>
    ...
    <link href="vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
		...
		<%
		  ...
		  String codigoClientes = obj.buscarCodigoCliente();
	                    ...
	                    <form class="user">
	                                    	<div class="form-group">
	                                            <input type="text" name="cod" class="form-control form-control-user"  
	                                               readonly="readonly" value="<%=codigoClientes%>">
	                                        </div>
	                                        <!-- no validar -->
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Rif..." name="txtRif">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Nombre de la Empresa..." name="txtNombreEmpresa">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Contacto..." name="txtContacto">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Direccion..." name="txtDireccion">
	                                        </div>
	                                        <div align=center>
		                                        <div class="col-6">
							        ...
							        function enviarDatos(){
							        	...
							        	document.forms[0].accion.value="nuevoCliente";
							        	document.forms[0].submit();
							        }
							        </script>
								 <%
								  if(request.getParameter("accion")!=null && request.getParameter("accion").equals("nuevoCliente")){
