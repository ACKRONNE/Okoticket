...
<%@page import="Utilidades.ConexionDB,java.sql.*,DAO.StatusDAO" %>
<html>
<head>
...
<%
    	    ...
    	    Status bean = obj.buscarStatu(cod);
	                ...
	                <div class="col-6 p-5" >
	                    ...
	                    <form class="user">
	                                    	<div class="form-group">
	                                           <input type="text" name="cod" class="form-control form-control-user" value="<%=bean.getIdStatus()%>"
                               					readonly="readonly">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Status..." name="txtStatus" value="<%=bean.getStatus()%>">
	                                        </div>
								        ...
								        function enviarDatos(){
								        	if(document.forms[0].txtStatus.value.length==0){
								        		alert("Ingrese Status");
								            	return;	
								        	}
								
								        	document.forms[0].accion.value="editarStatus";
								        	document.forms[0].submit();
								        }
								        </script>
								        
								        <%
								        if(request.getParameter("accion")!=null && request.getParameter("accion").equals("editarStatus")){
								      	  
								        	Status beanStatu = new Status();
								        	
								        	beanStatu.setIdStatus(request.getParameter("cod"));
										  	beanStatu.setStatus(request.getParameter("txtStatus"));
										  	
								            obj.actualizar(beanStatu);
