<!DOCTYPE html>
<html lang="en">
<%@page import="Entidad.Status,DAO.StatusDAO,java.util.ArrayList" %>
<head>
    ...
    <link href="vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
		...
		<%
		  ...
		  String codigoStatus = obj.buscarCodigoStatu();
                ...
                <div class="row">                
	                <div class="col-6 p-5" >
						<div class="text-center">
	                         <h1 class="h4 text-gray-900 mb-4">Nuevo Status</h1>
	                    </div>
	                    <form class="user">
	                                    	<div class="form-group">
	                                            <input type="text" name="cod" class="form-control form-control-user"  
	                                               readonly="readonly" value="<%=codigoStatus%>">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Status..." name="txtStatus">
	                                        </div>
							        ...
							        function enviarDatos(){
							        	...
							        	document.forms[0].accion.value="nuevoStatus";
							        	document.forms[0].submit();
							        }
							        </script>
								 <%
								  if(request.getParameter("accion")!=null && request.getParameter("accion").equals("nuevoStatus")){
									  
									Status beanStatus = new Status();
									
								  	beanStatus.setIdStatus(request.getParameter("cod"));
								  	beanStatus.setStatus(request.getParameter("txtStatus"));								  
								    obj.insertar(beanStatus);
