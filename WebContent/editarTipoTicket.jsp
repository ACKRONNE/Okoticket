...
FECHA 10/07/2022
TITULO: EDITA TIPO TICKET -->

<!DOCTYPE html>
<%@page import="Entidad.TipoTickets"%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="Utilidades.ConexionDB,java.sql.*,DAO.TipoTicketsDAO" %>
<html>
<head>
...
<%
    	    ...
    	    TipoTickets bean = obj.buscarTipoTicket(cod);
	                ...
	                <div class="col-6 p-5" >
	                    ...
	                    <form class="user">
	                                    	<div class="form-group">
	                                           <input type="text" name="cod" class="form-control form-control-user" value="<%=bean.getIdTipo()%>"
                               					readonly="readonly">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Tipo de Ticket..." name="txtTipo" value="<%=bean.getRequerimiento()%>">
	                                        </div>
								        ...
								        function enviarDatos(){
								        	if(document.forms[0].txtTipo.value.length==0){
								        		alert("Ingrese Tipo de Ticket");
								            	return;	
								        	}
								
								        	document.forms[0].accion.value="editarTipoTicket";
								        	document.forms[0].submit();
								        }
								        </script>
								        
								        <%
								        if(request.getParameter("accion")!=null && request.getParameter("accion").equals("editarTipoTicket")){
								      	  
								        	TipoTickets beanTipoTicket = new TipoTickets();
								        	
								        	beanTipoTicket.setIdTipo(request.getParameter("cod"));
										  	beanTipoTicket.setRequerimiento(request.getParameter("txtTipo"));
										  	
								            obj.actualizar(beanTipoTicket);
