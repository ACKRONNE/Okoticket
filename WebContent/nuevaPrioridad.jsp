<!DOCTYPE html>
<html lang="en">
<%@page import="Entidad.Prioridades,DAO.PrioridadesDAO,java.util.ArrayList" %>
<head>
...
<%
		  ...
		  String codigoPrioridad = obj.buscarCodigoPrioridad();
                ...
                <div class="row">                
	                <div class="col-6 p-5" >
						<div class="text-center">
	                         <h1 class="h4 text-gray-900 mb-4">Nueva Prioridad</h1>
	                    </div>
	                    <form class="user">
	                                    	<div class="form-group">
	                                            <input type="text" name="cod" class="form-control form-control-user"  
	                                               readonly="readonly" value="<%=codigoPrioridad%>">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Prioridad..." name="txtPrioridad">
	                                        </div>
							        ...
							        function enviarDatos(){
							        	if(document.forms[0].txtPrioridad.value.length==0){
							        		alert("Ingrese Prioridad");
							            	return;	
							        	}
							
							        	document.forms[0].accion.value="nuevaPrioridad";
							        	document.forms[0].submit();
							        }
							        </script>
								 <%
								  if(request.getParameter("accion")!=null && request.getParameter("accion").equals("nuevaPrioridad")){
									  
									Prioridades beanPrioridad = new Prioridades();
									
								  	beanPrioridad.setIdPrioridades(request.getParameter("cod"));
								  	beanPrioridad.setPrioridades(request.getParameter("txtPrioridad"));	
								  						  
								    obj.insertar(beanPrioridad);
