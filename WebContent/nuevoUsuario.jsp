...
<!DOCTYPE html>
<html lang="en">
<%@page import="Entidad.Usuarios,Entidad.TipoUsuario,DAO.UsuariosDAO,java.util.ArrayList" %>
<head>
...
<%
		  ...
		  String codigoUsuario = obj.buscarCodigoUsuario();
	                    ...
	                    <form class="user">
	                                    	<div class="form-group">
	                                            <input type="text" name="cod" class="form-control form-control-user"  
	                                               readonly="readonly" value="<%=codigoUsuario%>">
	                                        </div>
	                                        
	                                        <div class="form-group">									      
											<select class=" form-control form-control-user" name="txtcboRol"> 
										
								                    <option value="-1">Seleccione</option>
								                    <%
								                    for(TipoUsuario tipoUsuario:obj.listarTipoUsuario()){
								                    	%>
								                    <option value="<%=tipoUsuario.getTipoUsuario()%>" ><%=tipoUsuario.getTipoUsuario()%></option>	
								                    	<%
								                    }
								                    %>
								                    </select>										   
	                                        ...
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Cedula..." name="txtCedula">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                        ...
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Correo (@okotecnologia.com)..." name="txtCorreo" id="txtCorreo">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="password" class="form-control form-control-user"  
	                                                placeholder="Ingrese Contraseña..." name="txtContrasena">
	                                        </div>
	                                        <div align=center>
		                                        <div class="col-6">
							        ...
							        function enviarDatos(){
							        	...
							        	document.forms[0].accion.value="nuevoUsuario";
							        	document.forms[0].submit();
							        }
							        </script>
								 <%
								  if(request.getParameter("accion")!=null && request.getParameter("accion").equals("nuevoUsuario")){
									  
									Usuarios beanUsuario = new Usuarios();
									
								  	beanUsuario.setIdUsuario(request.getParameter("cod"));
								  	beanUsuario.setRol(request.getParameter("txtcboRol"));
