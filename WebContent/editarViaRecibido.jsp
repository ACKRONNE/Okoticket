...
FECHA 10/07/2022
TITULO: EDITA VIA RECIBIDO -->

<!DOCTYPE html>
<%@page import="Entidad.ViaRecibidos"%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="Utilidades.ConexionDB,java.sql.*,DAO.ViaRecibidosDAO" %>
<html>
<head>
...
<%
    	    ...
    	    ViaRecibidos bean = obj.buscarViaRecibido(cod);
                ...
                <div class="row">
	                ...
	                <div class="col-6 p-5" >
						<div class="text-center">
	                         <h1 class="h4 text-gray-900 mb-4">Editar Via Recibido</h1>
	                    </div>
	                    <form class="user">
	                                    	<div class="form-group">
	                                           <input type="text" name="cod" class="form-control form-control-user" value="<%=bean.getIdVia()%>"
                               					readonly="readonly">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Status..." name="txtVia" value="<%=bean.getViaRecibido()%>">
	                                        </div>
								        ...
								        function enviarDatos(){
								        	if(document.forms[0].txtVia.value.length==0){
								        		alert("Ingrese Via de Recibido");
								            	return;	
								        	}
								
								        	document.forms[0].accion.value="editarViaRecibido";
								        	document.forms[0].submit();
								        }
								        </script>
								        
								        <%
								        if(request.getParameter("accion")!=null && request.getParameter("accion").equals("editarViaRecibido")){
								      	  
								        	ViaRecibidos beanViaRecibido = new ViaRecibidos();
								        	
								        	beanViaRecibido.setIdVia(request.getParameter("cod"));
										  	beanViaRecibido.setViaRecibido(request.getParameter("txtVia"));
										  	
								            obj.actualizar(beanViaRecibido);
