...
<head>
    ...
    <link href="vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
		...
		<%
		  ...
		  String codigoVia = obj.buscarCodigoVia();
                ...
                <div class="row">                
	                <div class="col-6 p-5" >
						<div class="text-center">
	                         <h1 class="h4 text-gray-900 mb-4">Nueva Via Recibido</h1>
	                    </div>
	                    <form class="user">
	                                    	<div class="form-group">
	                                            <input type="text" name="cod" class="form-control form-control-user"  
	                                               readonly="readonly" value="<%=codigoVia%>">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="text" class="form-control form-control-user"  
	                                                placeholder="Ingrese Via Recibido..." name="txtVia">
	                                        </div>
							        ...
							        function enviarDatos(){
							        	...
							        	document.forms[0].accion.value="nuevoViaRecibido";
							        	document.forms[0].submit();
							        }
							        </script>
								 <%
								  if(request.getParameter("accion")!=null && request.getParameter("accion").equals("nuevoViaRecibido")){
									  
									ViaRecibidos beanViaRecibidos = new ViaRecibidos();
									
								  	beanViaRecibidos.setIdVia(request.getParameter("cod"));
								  	beanViaRecibidos.setViaRecibido(request.getParameter("txtVia"));								  
								    obj.insertar(beanViaRecibidos);
